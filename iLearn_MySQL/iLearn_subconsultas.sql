...
#la diferencia del titulo nombre 'uno' al titulo más caro es de -40.00 que el mas caro es 'Java en 10 minutos'

select titulo, autor, precio from libros where precio=(select max(precio) from libros);
#me trae 'Java en 10 minutos' el más caro de la tabla libros
...
#mismo resultado subconsulta 1
 ...
 #Si los libros de Borges me coinciden con algunas de las editoriales que han publicado libros de Richard Bach
 ...
 #Muestra además el precio más alto de la subconsulta
...
drop table if exists detalles;
 ...
 #una lista de los clientes que han comprado el articulo de lápiz
