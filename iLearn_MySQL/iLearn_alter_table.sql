...
#modificar campos y atributos sin tener que eliminar las tablas, cambiar campos
...
alter table productos add primary key(nombre); #da error
alter table productos modify id int unsigned auto_increment not null;   #el modify modifica el id para autoincrementar
...
alter table productos add index i_preciocantidad(precio,cantidad);
alter table productos drop index i_preciocantidad;
